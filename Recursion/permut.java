...
public class permut {
    ...
    public static void helper(int pos, int n, int[] nums, List<List<Integer>> ans) {
        // If we have reached the end of nums, we have found a Valid Permutations of
        // nums
        ...
        // Otherwise we iterate over all the other elements and try to generate
        // Permutations by swapping element at pos with element at i
    ...
    public static List<Integer> ConverttoArray(int[] nums) {
